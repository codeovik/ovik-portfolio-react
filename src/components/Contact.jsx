...
export default function Contact() {
  return (
    <section className="lg:mt-150 mt-100 text-black dark:text-white max-w-[1400px] mx-auto px-20 md:px-40">
      <h2 className="text-center font-medium lg:text-7xl md:text-6xl text-5xl mb-10">Get in Touch</h2>
      <div className="grid lg:grid-cols-[2fr_1fr] gap-40">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d2955.097803019077!2d89.8351224416059!3d23.603694549300005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1752849927608!5m2!1sen!2sbd" className="lg:h-full transition-all md:aspect-video aspect-square w-full rounded-lg lg:rounded-2xl border-1 lg:border-2 border-black/5 dark:border-white/5 hover:border-primary/50" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </section>
  );
}